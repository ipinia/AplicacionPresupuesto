const ingresos = [new Ingreso("lodo", 8000), new Ingreso("Venta", 600)];

const egresos = [new Egreso("xxx", 2000), new Egreso("Ropa", 100)];
...
const crearIngresoHTML = (ingreso) => {
    let ingresoHTML = `<div class="elemento limpiarEstilos">
                    <div class="elemento_descripcion">
                        ${formatoMoneda(ingreso.descripcion)}
                    </div>
...
const crearEgresoHTML = (egreso) => {
    ...
    <div class="elemento_descripcion">
       ${formatoMoneda(egreso.descripcion)}
    </div>
    <div class="derecha limpiarEstilos">
